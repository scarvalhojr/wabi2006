...
minimization, which fills every spot with a probe~$p$ minimizing $\mathcal{C}(p)$.
...
between a probe
and its neighbors; thus both versions of Row-epitaxial and Sequential
for conflict index minimization are significantly slower. For this reason,
